...
@Setter
@Getter
public class ReversiGameEngineBoard {
    ...
    public ReversiGameEngineBoard() {
        this.gameBoardStr = getEmptyBoard();
    }

    public ReversiGameEngineBoard(char [][] gameBoardArray) {
        this.setGameBoardAsArray(gameBoardArray);
    }

    public ReversiGameEngineBoard(String gameBoardStr) {
